...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_meter_set_scale_ticks(ui->screen_meter_1, ui->screen_meter_1_scale_0, 41, 2, 10, lv_color_hex(0xff0000));
    lv_meter_set_scale_major_ticks(ui->screen_meter_1, ui->screen_meter_1_scale_0, 8, 5, 15, lv_color_hex(0xffff00), 10);
    lv_meter_set_scale_range(ui->screen_meter_1, ui->screen_meter_1_scale_0, 0, 100, 300, 90);
